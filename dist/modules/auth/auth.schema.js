...
exports.RegisterTutorSchema = exports.RegisterStudentSchema = exports.LoginSchema = void 0;
...
exports.RegisterStudentSchema = {
    ...
    body: Joi.object({
        fullName: Joi.string().trim().min(3).required().messages({
            ...
            'string.min': 'Full name must be at least 3 characters long, please remove leading or trailing spaces',
        }),
